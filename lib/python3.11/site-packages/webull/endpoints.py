...
class urls :
    ...
    def openorder(self, _acct_id):
        return f'{self.base_ustrade_url}/trading/v1/webull/order/openOrders?secAccountId={_acct_id}'    

    def account(self, _acct_id):
        return f'{self.base_ustrade_url}/trading/v1/webull/account/accountAssetSummary/v2?secAccountId={_acct_id}'

    def account_id(self, _acct_id):
        return f'{self.base_ustrade_url}/trading/v1/webull/account/accountAssetSummary/v2?secAccountId={_acct_id}'

        #/trading/v1/webull/account/accountAssetSummary/v2?secAccountId=12001983'
    ...
    def option_quotes(self):
        return f'{self.base_fintech_gw_url}/quote/option/quotes/queryBatch?'
        # deprecated return f'{self.base_options_gw_url}/quote/option/query/list'
    ...
    def paper_account(self, paper_acct_id):
        return f'{self.base_paperfintech_url}/paper/v1/account/summary?paperId=1&accountId={paper_acct_id}'
    ...
    def paper_place_option_order(self):
        return f'{self.base_paper_url}/paper/v1/order/optionPlace'

    def place_option_order(self, account_id):
